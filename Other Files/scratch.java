...
public class HalfPrecisionConverter {
    ...
    public static String convertInput(String input) {
        ...
        if (normalized.contains("x2^-")) {
            ...
            System.out.println("Parts array: " + Arrays.toString(parts)); // Print the parts array
    ...
    public static String adjustExponent(String input) {
        ...
        System.out.println(exponentDifference);
    ...
    private static String normalize(String input) {
        ...
        if (exponentIndex != -1) {
            ...
            System.out.println(exponentSubstring);
...
if ((normalized.indexOf('^') + 1 == '-') && (normalized.indexOf('^') + 2 > 1)
|| ((normalized.indexOf('^') + 2 == 1) && (normalized.indexOf('^') + 3 >= 4))) {
String[] parts = normalized.split("x2\\^");
